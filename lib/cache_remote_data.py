...
def _gcf():
    """Lazily import check_files functions"""
    global _check_files
    if _check_files is None:
        from . import check_files as _check_files
    return _check_files
...
def _cache_paleotopography_data(p: PathConfigManager):
    ...
    _gcf().check_paleotopography_data(
